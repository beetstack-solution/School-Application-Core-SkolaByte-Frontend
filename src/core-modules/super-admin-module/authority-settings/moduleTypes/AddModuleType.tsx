...
import { createData } from "@/api/super-admin-api/authority-setting-api/ModuleTypeApi";
...
const AddModuleType: React.FC<AddFinancialYearProps> = ({ onClose, onReload }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast.error(error.message || "Failed to create Module Type. Please try again.");
      setError(error.message || "Failed to create Module Type. Please try again.");
    }
  };
