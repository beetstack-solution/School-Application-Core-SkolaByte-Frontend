...
import {
  fetchFeatureById,
  FeatureModuleData,
} from "@/api/super-admin-api/FeatureModuleApi"; // Adjust the import path as needed
import Breadcrumb from "@/components/Breadcumb";

const ViewFeatureModule: React.FC = () => {
  const { id } = useParams<{ id: string }>(); // Get feature ID from URL
  const [featureData, setFeatureData] = useState<FeatureModuleData | null>(null);
  ...
  const breadcrumbItems = [
    { label: "Home", path: "/" },
    { label: "Features", path: "/feature-module" },
