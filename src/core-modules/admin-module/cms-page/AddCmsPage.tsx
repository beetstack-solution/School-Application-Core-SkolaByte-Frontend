...
import { createPage } from "@/api/super-admin-api/cms-page-api/cmsPageApi";
...
const AddCmsPage = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const response: any = await createPage(formDataToSend);
