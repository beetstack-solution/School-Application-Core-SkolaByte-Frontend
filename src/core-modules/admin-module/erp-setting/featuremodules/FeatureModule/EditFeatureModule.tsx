...
//   fetchFeatureModule,
//   FeatureModuleData,
// } from "@/api/FeatureModuleApi"; // Adjust import path if necessary
...
// const EditFeatureModule: React.FC<EditFeatureModuleProps> = ({ featureId, onClose }) => {
...
//       toast.success("Feature module updated successfully!");
//       console.log("Feature module updated:", response);
//     } catch (error) {
//       console.error("Error updating feature module:", error);
//       toast.error("Failed to update feature module. Please try again.");
//       setError("Failed to update feature module. Please try again.");
//     }
//   };
