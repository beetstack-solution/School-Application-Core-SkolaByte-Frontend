...
// } from "@/api/FeatureModuleApi"; // Adjusted to import FeatureApi
...
//                   <Link to={`/view-feature-module/${item._id}`}>
...
//         <div className="fixed inset-0 flex justify-center items-center bg-gray-900 bg-opacity-50 z-50">
//           <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg">
//             <EditFeatureModule featureId={selectedId} onClose={handleCloseEdit} onReload={handleReload} />{" "}
//           </div>
//         </div>
//       )}
