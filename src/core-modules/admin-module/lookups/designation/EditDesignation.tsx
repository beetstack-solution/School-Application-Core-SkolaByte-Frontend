import { getDesignationById, updateDesignation } from '@/api/admin-api/lookups-api/designationApi';
...
const EditDesignation: React.FC<AddFeeInstallmentTypeProps> = ({ onClose, onReload, ptaRoleId }) => {
    ...
    const fetchPtaRoleById = async (id: string) => {
        try {
            const response: any = await getDesignationById(id);
            if (response.success) {
   ...
   useEffect(() => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response: any = await updateDesignation(ptaRoleId, payload);
            if (response.success) {
