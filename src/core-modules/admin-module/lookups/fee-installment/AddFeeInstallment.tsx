...
function AddFeeInstallment() {
    ...
    const addInstallmentField = () => {
        setFormData(prev => ({
            ...prev,
            installments: [...prev.installments, { name: "" }]
        }));
    };
    ...
    const breadcrumbItems = [
        ...
        { label: "Add Fee Installments", path: "" },
    ];
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const payload:any = {
                ...
                installments: formData.installments.map((installment:any) => ({
                    name: installment.name,
                })),
            };

            const response:any = await createFeeInstallment(payload);
            if (response.success) {
    ...
    return (
        <div className="mt-2">
            <div className="flex flex-col md:flex-row justify-between items-center px-1 mb-3">
                <div>
                    <h3 className="text-xl font-semibold mb-4">Add Fee Installments</h3>
