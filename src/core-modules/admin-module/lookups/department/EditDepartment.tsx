...
import { getDepartmentById, updateDepartment } from '@/api/admin-api/lookups-api/departmentApi';
...
const EditDepartment: React.FC<AddFeeInstallmentTypeProps> = ({ onClose, onReload, ptaRoleId }) => {
    ...
    const fetchPtaRoleById = async (id: string) => {
        try {
            const response: any = await getDepartmentById(id);
            if (response.success) {
   ...
   useEffect(() => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response: any = await updateDepartment(ptaRoleId, payload);
            if (response.success) {
