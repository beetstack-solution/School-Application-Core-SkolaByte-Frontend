...
import { getDepartmentById } from "@/api/admin-api/lookups-api/departmentApi";
...
function ViewDepartment() {
    ...
    const fetchFeeTypeById = async (paramId: string) => {
        try {
            const responseData: any = await getDepartmentById(paramId);
    ...
    const breadcrumbItems = [
        { label: "Home", path: "/" },
        { label: "Departments", path: "/lookups/department" },
        { label: "View Department", path: "" },
    ];
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-gray-800">View Department</h2>
                    <div className="mt-2">
