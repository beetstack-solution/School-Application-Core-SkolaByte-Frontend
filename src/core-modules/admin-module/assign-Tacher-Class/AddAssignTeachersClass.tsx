...
import { CreateAssignTeachersClass } from '@/api/admin-api/lookups-api/assignTeachersClassApi'
import {
    AcademicYear,
    Division,
    fetchAcademicYear,
...
function AddAssignTeachersClass() {
    ...
    const breadcrumbItems = [
        ...
        { label: "Add Teachers Classes", path: "" },
    ];
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await CreateAssignTeachersClass(payload);
            if (response.success) {
        ...
        <div className="container mx-auto p-2">
            <div className="container mx-auto p-2">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-800">Assign Teacher to Class</h2>
                        <div className="mt-2">
...
export default AddAssignTeachersClass;